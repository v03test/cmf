<?php /*a:2:{s:47:"themes/admin_simpleboot3/admin\users\lists.html";i:1610940910;s:80:"D:\phpstudy_pro\WWW\ThinkCMF\public/themes/admin_simpleboot3/public\headers.html";i:1610004213;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    {{# if(d[i].userState==0){ }}
                                    <a class="red" href="javascript:;" onclick="user_state({{d[i].userId}});">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("Users/lists"); ?>', {page: curr || 1,key:key}, function(data){
    ...
    function user_state(id){
        let url = '<?php echo url("user_state"); ?>';
